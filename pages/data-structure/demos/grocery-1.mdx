# Grocery 1 - Data Structure

**End point:** `/api/grocery-1/navigation`  
**Used in:** Grocery-1, SideNavbar
...
**End point:** `/api/grocery-1/services`  
**Used in:** Grocery-1, Section2
...
**End point:** `/api/grocery-1/popular-products`  
**Used in:** Grocery-1, ProductCarousel - Section3
...
**End point:** `/api/grocery-1/trending-products`  
**Used in:** Grocery-1, ProductCarousel - Section4
...
**End point:** `/api/grocery-1/all-products`  
**Used in:** Grocery-1, AllProducts - Section5
...
**End point:** `/api/grocery-1/category-based-products`  
**Used in:** Grocery-1, AllProducts - Section5
...
```ts
// called from client
fetch("/api/grocery-1/category-based-products", { params: { category: selectedCategory } })
