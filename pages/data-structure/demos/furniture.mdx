# Furniture 1 - Data Structure

**End point:** `/api/furniture-1/main-carousel`  
...
**End point:** `/api/furniture-1/navigation`  
...
**End point:** `/api/furniture-1/top-new-products`  
...
**End point:** `/api/furniture-1/top-selling-products`  
**Used in:** Furniture, Section3
...
**End point:** `/api/furniture-1/all-products`  
