...
**End point:** `/api/gadget-store/main-carousel`  
...
**End point:** `/api/gadget-store/top-picks-list`  
**Used in:** Gadget Shop, Section1
...
**End point:** `/api/gadget-store/featured-categories`  
...
**End point:** `/api/gadget-store/two-banners`  
...
**End point:** `/api/gadget-store/most-viewed`  
...
**End point:** `/api/gadget-store/new-arrival`  
...
**End point:** `/api/gadget-store/blog-lists`  
