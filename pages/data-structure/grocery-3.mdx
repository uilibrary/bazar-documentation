# Grocery 3 - Data Structure

**End point:** `/api/grocery-3/main-carousel`  
**Used in:** Grocery-3, Section1
...
**End point:** `/api/grocery-3/offer-products`  
**Used in:** Grocery-3, Section2
...
**End point:** `/api/grocery-3/top-sailed-products`  
**Used in:** Grocery-3, Section3
...
**End point:** `/api/grocery-3/all-products`  
**Used in:** Grocery-3, Section4
