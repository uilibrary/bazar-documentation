...
Theme folder structure should look like this:
...
We added multiple theme options based on the different homepages. In your project
just keep the default theme option then remove other theme options
