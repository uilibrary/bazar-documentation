...
- `src/app/` : Bazaar has more than 55 pages in total, and this folder contained all of the page folders. For creating page we follow the next 13 app router approach. If you want to learn more about go here [Next.js Routing](https://nextjs.org/docs/app/building-your-application/routing)
